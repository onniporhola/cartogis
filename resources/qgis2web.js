...
map.getView().fit([250535.990308, 6579797.222507, 525972.777214, 6788531.847765], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Flying squirrel observations in Uusimaa region</h2>';
        return titleElement;
    })(),
